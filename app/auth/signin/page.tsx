    ...
    <div className="mx-auto mt-6 grid w-full max-w-5xl grid-cols-1 gap-6 lg:mt-10 lg:grid-cols-2">
      ...
      >
        ...
        <p className="mt-4 max-w-sm text-slate-300">
          Build short links, manage destinations, and review analytics without
          complexity.
        </p>
        <div className="mt-8 space-y-3">
          <AuthHighlight text="One dashboard for every link" />
          <AuthHighlight text="Fast redirects with usage insights" />
          <AuthHighlight text="Secure account and token-based sessions" />
        </div>
      </motion.section>
      ...
      >
        ...
        <p className="mt-2 text-sm text-slate-300">Use your account credentials.</p>
